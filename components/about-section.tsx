    ...
    <section id="about" className="px-4 py-12 sm:px-6 md:px-8 md:py-16 lg:px-10">
      <div className="mx-auto w-full max-w-350 2xl:max-w-400">
        ...
        <motion.div
          ...
          className="grid gap-6 overflow-hidden rounded-4xl border border-slate-700/60 bg-linear-to-br from-slate-950/80 via-blue-950/25 to-violet-950/25 p-5 shadow-[0_20px_60px_rgba(2,6,23,0.5)] backdrop-blur-2xl sm:p-6 md:gap-8 md:grid-cols-[minmax(240px,280px)_minmax(0,1fr)] md:p-8 lg:p-10"
        >
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              {SOCIAL_LINKS.map((social) => (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className={`inline-flex items-center gap-2 rounded-full border border-slate-700/80 bg-slate-900/75 px-4 py-2 text-sm text-slate-200 transition ${socialHoverClassByLabel[social.label as keyof typeof socialHoverClassByLabel]}`}
                >
                  {(() => {
